...
class TodayProduct extends StatefulWidget {
  const TodayProduct({Key? key}) : super(key: key);

  @override
  State<TodayProduct> createState() => _TodayProductState();
}

class _TodayProductState extends State<TodayProduct> {
  var selectedId = 0;
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          SizedBox(height: 10),
          _buildBookList(
              "book10", "[국내도서] 아주 오랜만에 행복하다는 느낌", "백수린(지은이)", "창비",
          ...
          SizedBox(height: 20),
          _buildBookList(
              "book01", "[국내도서] 커튼콜은 사양할게요", "김유담(지은이)", "창비",
